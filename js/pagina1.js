...
$("#solo").css("color","purple").css("font-size","100px").css("text-align","center");

$("#solo").click(function(){
	$("#mas").text("Describe why you agree or not with the new boarding pass");
	$("#mas").css("color","pink").css("font-size","50px");
});
